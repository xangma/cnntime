...
cp dgp_parameterfile.txt dgp_parameterfile.txt.${runnum}
CONFIG_FILE=dgp_parameterfile.txt.${runnum}
...
mpirun -np 1 /users/moricex/PAPER2/MG-PICOLA-PUBLIC/MG_PICOLA_DGP ${RUNDIR}${CONFIG_FILE}
